...
- To run "8.RankStudents" inside the manual mode: Step 1, create assignment(s). Two, add multiple students which is option 1. Three, option 4 add an assignment(s) to your rubric (the one(s) completed in step 1). Finally, type '8' and type in the rubric that you created in step 3. 
